...
| The website also provides access to the *ebook* [Bioquímica Básica, de Gente, de Bicho, e de Planta](https://www.researchgate.net/publication/388790659_Bioquimica_basica_de_gente_de_bicho_e_de_planta) or its [digital version on the website](/nivel/superior/biqTxT/index_txt_en.html), a basic text for undergraduate students in the field, for reference to various contents, but without codes.
...
| For basic educatifon, the website offers a set of instructional content and teaching objects for the final years of elementary school and high school. Its content was also designed according to the principles of *reproducible teaching* (RT) and involves *Reproducible Teaching Interactive Objects (RITO)* for curricular content.
 

| In this sense, the website presents applications of the *JSPlotly* (simulator) and *GSPlotly* (code generator) platforms directly aimed at basic education content. The website also has a tutorial on the practical use of *Jmol* for 3D molecules and interactivity, and another for *R in the RStudio environment*, for interactive graphics and maps. The tools are presented in their cloud versions, eliminating the need for installation or configuration, although there are instructions for installing the program on a machine. The tutorial is illustrated with examples taken from *MAPA* ([Pedagogical Support Material for Learning in Minas Gerais](https://seliga.educacao.mg.gov.br/cadernos-mapa-2025)). This content can also be accessed in the *ebook* [Bringing Content to Life for Basic Education: Molecules, Graphics, and Interactive Maps](https://www.researchgate.net/publication/392460244_Vivificando_Conteudos_Para_o_Ensino_Basico_Moleculas_Graficos_e_Mapas_Interativos), an adaptation for a smooth learning curve of Jmol and R & RStudio, and directly applied in the construction of reproducible interactive teaching objects (RITO) for school content.

The portal also provides a collection of interactive atomic models included in a *“Molecule Garden”* and a repository for interactive graphics and maps as RITO. The *Molecule Garden* is organized into classes and has a collection of atomic models for three-dimensional visualization and study.
