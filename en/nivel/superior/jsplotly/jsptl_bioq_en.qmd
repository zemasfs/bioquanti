...
## **General Biophysical Chemistry** {.unnumbered}
...
## Lineweaver-Burk treatment of Michaelis-Mentem data
...
- 5. To adjust the filter, modify its parameters in the *window* (sliding window) and/or *degree* (degree of the polynomial) constants.
...
- 4. To superimpose the fitted curve, update the *ajuste* and *trace* constants (vectors *S_fit* and *v_fit*), and choose *lines* in *mode*.

[![](Eq/ajNonLinGauss2.png)](Eq/jsp_ajNonLinGauss3.html){target="_blank"}



## **Experimental Simulation** {.unnumbered}


## Characterization of amino acids and chains
...
- models loaded online from the [PDB](https://www.rcsb.org/) or [PubChem](https://pubchem.ncbi.nlm.nih.gov/) websites;
