...
---
 ...
 The program was adapted from the DATFIT program code (Coffin, 1995) and is available on the [hpcalc.org](https://www.hpcalc.org) portal at this [link](https://www.hpcalc.org/search.php?query=nlFIT). It has the following features and advantages:
\
