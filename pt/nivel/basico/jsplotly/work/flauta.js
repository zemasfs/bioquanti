...
// 👇 Sobrescreve a função do botão "html" só se for flauta
function salvarProjetoSomenteGrafico() {
  ...
  // Checa se é SVG da flauta (e não gráfico Plotly)
  if (!svg || !svg.outerHTML.includes("circle")) {
    alert("Nenhum conteúdo SVG da flauta encontrado.");
    return;
  }
...
// Garante que o botão "html" usará esta versão personalizada:
