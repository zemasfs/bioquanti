...
###  Obras literárias e movimentos estéticos (Linguagens) {.unnumbered} 
...
###  Animação para lançamento oblíquo
...
###  Movimento de translação em sistema solar (dados aproximados)
...
###  Animação para mapa de áreas queimadas por biomas no Brasil (dados fictícios de 1955 a 2024)
...
###  Jogo da Vida de Conway (animação com menu) 
