...
### Frequência e vibração de cordas
...
### Aquisição de dados de sensores para Arduino (condutivimetria)
...
- 2. Copie, cole e rode o *script* do fabricante para TDS na IDE do Arduino conectado;
