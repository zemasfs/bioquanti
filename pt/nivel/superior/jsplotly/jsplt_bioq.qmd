...
### Interfaceamento com Arduino 

|   Visando ilustrar o potencial do *JSPlotly* para além do mundo virtual, o *script* que segue pode ser utilizado juntamente ao simulador para a conexão e aquisição de dados por placas microcontroladoras, como Arduino e ESP32. O código pode ser obtido clicando-se na imagem abaixo, e aborda uma aquisição em tempo real para *biocélula a combustível*, tal como ilustrado virtualmente no *Biocel-Toolkit* acima.

|   O código é adaptado para uso autônomo, bastando-se conectar o Arduino com um cabo serial à uma biocélula, seguindo-se do botão *Conectar*.
\

<!-- [script18.js](Eq/script18.js){download="script18.js"} -->

[![](Eq/toolkit/arduino.png)](Eq/toolkit/arduino.html)
\
