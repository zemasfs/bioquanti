...
## *Aplicativo* - Simulação experimental para caracterização de aminoácidos e cadeias  
...
## *Aplicativo* - ZeMol: um visualizador 3D para modelos moleculares
...
|   Como apresentado acima e constante dos livros didáticos, é possível linearizar a curva de Michaelis-Mentem para uma observação mais simples e diagnóstico de modelos de inibição enzimática, como apresentado pelo objeto interativo abaixo 
...
```{r, eval=FALSE}
1. Simule as condições para uma inibição competitiva alterando o valor de Km;
2. Faça o mesmo para um modelo não competitivo, embora alterando o valor de Vm;
