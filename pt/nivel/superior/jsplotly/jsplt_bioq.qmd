...
[![](Eq/leadCompound.png)](Eq/jsp_leadCompound.zip){target="_blank"}
...
2. Calcule o valor de "Ki" por métodos distintos utilizando-se o campo de preenchimento para os parâmetros da Tabela:
