...
|   Essa seção visa oferecer alguns *"kits de ferramentas"* para *simulações e experimentos simulados* em Biofísico-química para *cinética, interação, e estabilidade para alvos proteicos*. Cada *toolkit* permite uma apreciação entre métodos utilizados, aplicações, modelagem, e interpretação de parâmetros. Como um todo, os *toolkits* facultam um estudo integrado de cinética e termodinâmica para  aplicação em biotecnologia, biocatálise e descoberta de fármacos. Individualmente, os toolkits contemplam:

1. EK-Toolkit - modelagem em cinética e inibição enzimática;
2. LeadHunt - seleção de composto líder por inibição enzimática;
...
7. MFC-Toolkit - biocélula a combustível

### LeadHunt - Prospecção para composto líder como inibidor enzimático
...
*Observação*: o *LeadHunt* possui códigos internos para estilos e montagens do painel, e que interferem no *bootstratp* do criador de páginas web utilizado para o *Bioquanti* (pacote *Quarto* para *R*). Nesse sentido, clique na imagem abaixo para baixá-lo, e depois abrar-o num navegador. 
\

[![](Eq/leadCompound.png)](Eq/cindroga24.html){download="cindroga24.html"}
...
<!-- ### Arquivo HTML para cabo serial -->
<!-- [Arduino_biocel_cabo.html](Arduino_biocel_cabo.html){download="Arduino_biocel_cabo.html"} -->
