...
### CinDroga - Prospecção para composto líder como inibidor enzimático
...
2. Há dois modos para estudo para uso do *CinDroga*: inserindo-se parâmetros cinéticos e termodinâmicos para observar os resultados expressos em gráficos (botão *parâmetros*), ou caracterizar os parâmetros a partir dos gráficos (botão *diagnóstico*). 
...
#### Uso do CinDrogra para identificação de um composto líder {.unnumbered}
...
2. Calcule o valor de "Ki" por métodos distintos utilizando-se o campo de preenchimento para "replot" de parâmetros da Tabela:
