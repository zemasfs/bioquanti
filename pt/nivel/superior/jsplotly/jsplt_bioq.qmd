...
## *Aplicativo* - Experimentação simulada para caracterização de aminoácidos e cadeias  
...
## *Aplicativo* - Experimentação simulada para caracterização de carboidratos
...
## Experimentação Simulada - Prospecção para composto líder (*Lead Compounds*)

<!-- [![](Eq/leadCompound.png)](Eq/jsp_leadCompound.html){target="_blank"} -->

[![](Eq/leadCompound.png)](Eq/jsp_leadCompound.js){target="_blank"}
