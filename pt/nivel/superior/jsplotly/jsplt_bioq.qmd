...
|   Para ilustrar o potencial de uso do *JSPlotly* para Bioquímica e áreas correlatas, seguem alguns exemplos para gráficos, simulações, análise de dados, e aplicativos, e cujos conteúdos são frequentemente encontrados em livros-texto e fontes técnico-científicas. Para um melhor aproveitamento de cada tema, experimente seguir as Sugestão dos códigos para cada objeto.
\
