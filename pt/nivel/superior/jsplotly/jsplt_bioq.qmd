...
*Observação*: o *CinDroga* possui códigos internos para estilos e montagens do painel, e que interferem no *bootstratp* do criador de páginas web utilizado para o *Bioquanti* (pacote *Quarto* para *R*). Nesse sentido, para acessá-lo é necessário baixar o arquivo comprimido abaixo, descompactá-lo e carregar o aplicativo diretamente. Para isso, basta clicar na imagem que segue.
