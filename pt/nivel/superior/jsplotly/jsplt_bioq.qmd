...
1. [Firmware Arduino](Eq/Arduino/arduino.ino){download="arduino.ino"} ;
...
|   Para uso com rede *Wifi* é necessário utilizar-se este [firmware Arduino-Wifi](Eq/Arduino/arduino_wifi.ino){download="arduino_wifi.ino"} específico para a Biocélula. 
