...
<!-- ### [JSPlotly 1.0](JSPlotly.html){target="_blank"}  {.unnumbered} -->

### [JSPlotly](JSPlotly.html){target="_blank"}  {.unnumbered}

<!-- #### Funcionalidades adicionais: {.unnumbered} -->

<!-- - Barra superior com função expandida (*modeBar*); -->
<!-- - Otimização para dispositivos móveis; -->
<!-- - Botões do editor de códigos renovado; -->
<!-- - Botão *html* permite salvar o objeto em arquivo com possibilidade de animação; -->
<!-- - Botão *clone* permite clonar o código juntamente com o JSPlotly; -->
<!-- - Permite aprendizagem da linguagem *JavaScript* por saída de cálculos e expressões no ecrã, isoladamente, ou combinado a gráficos;  -->
<!-- - Permite animações (`frames`, `Plotly.animate` e `layout.annotations`), e suporte à biblioteca `p5.js` (para animações, jogos, interatividade avançada); -->
<!-- - Retrocompatibilidade de *scripts* da versão anterior -->
...
## Gerador de códigos por IA: *GSPlotly*
...
```{r, eval=FALSE}
1. Adicionar um gráfico ("add");
2. Remover o último gráfico ("remove");
3. Limpar a área gráfica ("clean");
4. Salvar o gráfico em formato interativo ("HTML");
5. Salvar o código ("script");
6. Limpar o editor ("clean")
```
