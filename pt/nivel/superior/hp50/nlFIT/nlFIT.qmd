...
6. Utiliza as subrotinas FDER e PGALL (Coffin, 1995) para cálculo da derivada simbólica da função, bem como para para eliminar variáveis previamente armazenadas, respectivamente (o programa original necessita de 3 subprogramas para rodar);
